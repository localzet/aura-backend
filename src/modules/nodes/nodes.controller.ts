import { NODES_CONTROLLER } from '@localzet/aura-backend-contract/api';
...
import { CreateNodeResponseModel, GetAllNodesResponseModel, GetOneNodeResponseModel } from './models';
